...
RELEASE_VERSION = "0.37.12.dev4"
RUST_COMMIT = "e1cc897d5c04d11e7773f54a659f98ec89ae224f"
...
RELEASE_TAG = "castlabs-v0.37.12.dev4"
...
RELEASE_BODY = (
    ...
    f"{RELEASE_IDENTITY_TEXT}. Conformance Program 0.2 / C2PA 2.4 candidate (successor to the published dev3; crJSON 2.4 conformance): "
...
def validate_lock(lock: dict[str, Any]) -> None:
    ...
    if lock["package"] != {"name": "c2pa-python", "version": RELEASE_VERSION}:
        fail("release lock package identity is not 0.37.12.dev4")
    if lock["pythonSource"] != {
        ...
        "releaseTag": "castlabs-v0.37.12.dev4",
    }:
