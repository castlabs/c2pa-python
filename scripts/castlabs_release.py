...
RELEASE_TAG = "castlabs-v0.37.8.dev4"
...
RELEASE_BODY = (
    ...
    "dev2 run 34057763620, and dev3 run 34065998820. See the attached schema-2 "
    "evidence and SHA-256 sidecars."
)
...
def validate_lock(lock: dict[str, Any]) -> None:
    ...
    if lock["package"] != {"name": "c2pa-python", "version": RELEASE_VERSION}:
        fail("release lock package identity is not 0.37.8.dev4")
    if lock["pythonSource"] != {
        ...
        "releaseTag": "castlabs-v0.37.8.dev4",
    }:
